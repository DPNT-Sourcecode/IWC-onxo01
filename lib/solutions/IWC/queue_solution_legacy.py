...
class Queue:
    ...
    def dequeue(self):
        ...
        def sort_task(task):
            ...
            user_tasks= task_count.get(task.user_id, 0)
            hold_bank_global= (is_bank and (not is_bank_old) and user_tasks<3)
            hold_bank_after_user= (is_bank and (not is_bank_old) and user_tasks>= 3)
            ...
            return (
                ...
                , priority
                , earliest
                , 1 if hold_bank_after_user else 0
